...
ADMINS = [("""Matar DIOP""", "matar@xamu.fr")]
...
ACCOUNT_FORMS = {"signup": "xamu.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "xamu.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "xamu.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "xamu API",
    "DESCRIPTION": "Documentation of API endpoints of xamu",
    "VERSION": "1.0.0",
